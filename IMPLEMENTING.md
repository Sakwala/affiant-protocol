...
driver does not run is an `error` outcome, not an absence. Expect to fail some of the 58 declarative fixtures and some
...
The 58 fixtures and seven canonical vectors as a test suite from day one, in a format that assumes nothing about your
