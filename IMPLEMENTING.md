...
Versions of this repository are git tags. The current one is `v0.1.3`; pin that, not a branch. (A commit is a
...
The 61 fixtures and seven canonical vectors as a test suite from day one — and, if you ship an adapter, the twelve of
the adapter section as well — in a format that assumes nothing about your language. The numbered rules as your design, already argued through and cited against the defects they correct. A row
