...
|---|---|---|
| [`dotnet-v0.1.json`](dotnet-v0.1.json) | [Sakwala/affiant](https://github.com/Sakwala/affiant) — the .NET packages at `1.0.0-beta.1` | **published** 2026-09-04. 60 failing rows of 63 fixtures run: 50 `planned`, every one for `1.0.0-beta.3`, and 10 `fenced`. All 19 fixtures in [`../ORACLE.md`](../ORACLE.md) appear in it and all 19 failed. The run is [`../results/dotnet-1.0.0-beta.1/`](../results/dotnet-1.0.0-beta.1/). |
