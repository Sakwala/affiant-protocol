...
|---|---|---|
| [`dotnet-v0.1.json`](dotnet-v0.1.json) | [Sakwala/affiant](https://github.com/Sakwala/affiant) — the .NET packages at `1.0.0-beta.3` | **published** 2026-09-05. An **empty** `failing[]` of 63 fixtures run. Read at `v0.1.2`; the negative-oracle assertion in [`../ORACLE.md`](../ORACLE.md) is a statement about the named release `1.0.0-beta.1` and reports itself skipped against this one. The run is [`../results/dotnet-1.0.0-beta.3/`](../results/dotnet-1.0.0-beta.3/). The prior reading — `1.0.0-beta.1` at `v0.1.1`, 60 of 63 failing rows, all 19 oracle fixtures failed — stays published at [`../results/dotnet-1.0.0-beta.1/`](../results/dotnet-1.0.0-beta.1/). |
